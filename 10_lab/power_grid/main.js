...
d3.queue()
    .defer(d3.csv, './gridkit_north_america-highvoltage-vertices.csv', function(row) {
    ...
    .defer(d3.csv, './gridkit_north_america-highvoltage-links.csv', function(row) {
...
function readyToDraw(error, nodes, links, states) {
    if(error) {
